            ...
            <div class="grid" style="margin-top: 1rem;">
                ...
                <div>
                    ...
                    <?php if ($total_late_fees > 0): ?>
                        <p><strong>Moras Cobradas:</strong> <span
                                style="color: #dc2626;">$<?= number_format($total_late_fees, 2) ?></span></p>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="grid" style="margin-top: 1rem;">
                                <div>
                                    <p><strong>Monto Prestado:</strong> $<?= number_format($loan['amount'], 2) ?></p>
                                    <p><strong>Interés:</strong> <?= $loan['interest_rate'] ?>% Mensual</p>
                                    <p><strong>Total a Pagar:</strong> $<?= number_format($loan['total_amount'], 2) ?>
                                    </p>
                                </div>
                                <div>
                                    <p><strong>Frecuencia:</strong> <?= ucfirst($loan['frequency']) ?></p>
                                    ...
                                    <?php if ($total_late_fees > 0): ?>
                                        <p><strong>Moras Cobradas:</strong> <span
                                                style="color: #dc2626;">$<?= number_format($total_late_fees, 2) ?></span>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div
                                style="margin-top: 1rem; background: #e2e8f0; height: 10px; border-radius: 5px; overflow: hidden;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (isset($payment['late_fee']) && $payment['late_fee'] > 0): ?>
                                                        <span
                                                            style="color: #dc2626; font-weight: bold;">$<?= number_format($payment['late_fee'], 2) ?></span>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td class="no-print">
                                                    <?php if ($payment['status'] == 'pending'): ?>
                                                        <a href="process_payment.php?id=<?= $payment['id'] ?>"
                                                            class="btn btn-sm">Pagar</a>
                                                    <?php else: ?>
